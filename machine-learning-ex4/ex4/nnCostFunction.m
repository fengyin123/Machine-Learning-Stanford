...
d3 = a3 - y_matrix;
d3_t2 = d3 * Theta2; %(5000 x 10) * (10 x 26)
d2 = d3_t2(:,2:end) .* sigmoidGradient(z2); %(5000 x 10) * (10 x 25) not to include bias "1" term

Delta1 = d2' * a1; %(25 x 5000) * (5000 x 401)
Delta2 = d3' * a2; %(10 x 5000) * (5000 x 26)
